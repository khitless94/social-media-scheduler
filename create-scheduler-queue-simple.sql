...
DROP POLICY IF EXISTS "Users can view their own scheduled posts" ON scheduled_posts_queue;
DROP POLICY IF EXISTS "Users can insert their own scheduled posts" ON scheduled_posts_queue;
DROP POLICY IF EXISTS "Users can update their own scheduled posts" ON scheduled_posts_queue;
DROP POLICY IF EXISTS "Service role full access" ON scheduled_posts_queue;
